...
import random
Wild_Pokemon = [
    {KEY_NAME:"Rotom",MAX_HEALTH: 50, WILD_ATTACK_MOVE1_NAME: "Hex", WILD_ATTACK_MOVE1_DAMAGE: 60, WILD_ATTACK_MOVE1_ACCURACY:100, WILD_ATTACK_MOVE2_NAME: "Thunder shock", WILD_ATTACK_MOVE2_DAMAGE: 40,WILD_ATTACK_MOVE1_ACCURACY:100},
    {KEY_NAME:"Mewtwo", MAX_HEALTH: 106, WILD_ATTACK_MOVE1_NAME: "Psychic", WILD_ATTACK_MOVE1_DAMAGE: 90,WILD_ATTACK_MOVE1_ACCURACY:100, WILD_ATTACK_MOVE2_NAME: "shodow ball", WILD_ATTACK_MOVE2_DAMAGE: 80,WILD_ATTACK_MOVE1_ACCURACY:100},
    {KEY_NAME:"Eternatus", MAX_HEALTH: 140, WILD_ATTACK_MOVE1_NAME: "Dynamax cannon", WILD_ATTACK_MOVE1_DAMAGE: 100,WILD_ATTACK_MOVE1_ACCURACY:100, WILD_ATTACK_MOVE2_NAME: "Sludge bomb", WILD_ATTACK_MOVE2_DAMAGE: 90,WILD_ATTACK_MOVE1_ACCURACY:100},
    {KEY_NAME: "Diglett", MAX_HEALTH: 10, WILD_ATTACK_MOVE1_NAME: "Dig",WILD_ATTACK_MOVE1_ACCURACY:100, WILD_ATTACK_MOVE1_DAMAGE: 80, WILD_ATTACK_MOVE2_NAME: "Fissure", WILD_ATTACK_MOVE2_DAMAGE: 1000000,WILD_ATTACK_MOVE1_ACCURACY:20}
]
...
while wild_pokemon_current_health >= 0:
    while True:
    ...
    print(f"the {randomised_wild_pokemon[KEY_NAME]} has {wild_pokemon_current_health} health left")
