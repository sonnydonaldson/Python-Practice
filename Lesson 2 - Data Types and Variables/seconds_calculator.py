...
answer_seconds = (number_of_days * NUMBER_OF_HOURS_IN_DAY * NUMBER_OF_MINUTES_IN_A_HOUR * NUMBER_OF_SECONDS_IN_MINUTE)
answer_minutes = (number_of_days * NUMBER_OF_HOURS_IN_DAY * NUMBER_OF_MINUTES_IN_A_HOUR)
answer_hours = ( number_of_days * NUMBER_OF_HOURS_IN_DAY)
